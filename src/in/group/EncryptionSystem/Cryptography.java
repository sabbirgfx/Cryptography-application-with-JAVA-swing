...
int wdth,hight;
    ...
    public Cryptography() {
        ...
        setResizable(false);
        label = new JLabel("CHOOSE THE FILE FOR ENCRYPTION OR DECRYPTION");
		...
		loadPanel.setBackground(Color.darkGray);
		...
		buttonPanel1.setBorder(BorderFactory.createLineBorder(Color.lightGray));
		buttonPanel2.setBorder(BorderFactory.createLineBorder(Color.lightGray));
